...
class SliderController extends Controller
{
    ...
    public static function middleware(): array
    {
        return [
            ...
            'permission:sliders.index|sliders.create|sliders.edit|sliders.delete|sliders.trash',
        ];
    }
    ...
    public function create()
    {
        return view('backend.slider.create', [
            'posts' => Post::publisheddate()->orderBy('created_at', 'desc')->get(),
        ]);
    }
    ...
    public function store(RequestSliderStore $request)
    {
        ...
        if ($request->has('image')) {
            ...
            $successUploaded = Image::read($image)->resize(1920, 1088);
    ...
    public function edit(Slider $slider)
    {
        return view('backend.slider.edit', [
            ...
            'posts' => Post::publishedate()->orderBy('created_at', 'desc')->get(),
            'slider' => $slider,
        ]);
    }
