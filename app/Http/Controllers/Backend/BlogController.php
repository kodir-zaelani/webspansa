...
class BlogController extends Controller
{
    ...
    */
    ...
    public function store(RequestBlogStore $request)
    {
        ...
        if ($blog) {
            ...
            return redirect()->route('backend.blog.index')->with(['success' => 'Add Blog ' . $blog['title'] . ' was successfully!']);
        } else {
    ...
    */
    public function update(RequestBlogUpdate $request, Blog $blog)
    {
        ...
        $oldBlogsubcategory = $blog->blogsubcategory;
        ...
        if (!empty($request->has('blogsubcategory_id'))) {
            $data = array_merge($data, [
                'blogsubcategory_id'    => $request->input('blogsubcategory_id'),
            ]);
        }
        ...
        if ($blog) {
            //redirect dengan pesan sukses
            return redirect()->route('backend.blog.index')->with(['warning' => 'Update Blog ' . $blog['title'] . ' was successfully!']);
        } else {
            //redirect dengan pesan error
