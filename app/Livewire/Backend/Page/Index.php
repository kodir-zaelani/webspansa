...
class Index extends Component
{
    ...
    public function changeInactive()
    {
        ...
        return redirect()->to('backend/pages')->with(['warning' => 'Page Change to Draft was successfully']);
    }
    public function changeActive()
    {
        ...
        return redirect()->to('backend/pages')->with(['success' => 'Page Change to Publish was successfully']);
    }
    public function changeImageinactive()
    {
        ...
        return redirect()->to('backend/pages')->with(['warning' => 'Image Page Change to unPublish was successfully']);
    }
    public function changeImageActive()
    {
        ...
        return redirect()->to('backend/pages')->with(['success' => 'Image Page Change to Publish was successfully']);
    }
    ...
    public function delete()
    {
        ...
        return redirect()->to('backend/pages')->with(['warning' => 'Remove Page was successfully']);
    }
