...
<div class="content-header">
    <div class="d-flex align-items-center">
                    ...
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('backend.dashboard') }}"><i class="fa fa-home"><span
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                href="{{ route('backend.editorials.index') }}">Editorial</a></li>
        ...
        <section class="content">
            <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.editorials.update', $editorial) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Edit a Editorial
                            </h4>
                        </div>
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    ...
                                    value="{{ old('title') ?? $editorial->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <div class="mt-2 input-group">
                                    ...
                                    value="{{ old('video') ?? $editorial->video }}">
                                    <a class="btn btn-sm btn-primary input-group-text popup-youtube" href="{{$editorial->video}}">{{ __('View')}}</a>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                name="content">{{ old('content') ?? $editorial->content }}</textarea>
                                @error('content')
                                <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                @enderror
                            </div>
                        ...
                        <div class="box-body">
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    ...
                                    type="date" value="{{ old('published_at') ?? $editorial->published_at }}"
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $editorial->imageThumbUrl ? $editorial->imageThumbUrl : '/assets/images/no_image.png' }}"
                                        alt="...">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        placeholder="Caption Image">{{ old('caption_image') ?? $editorial->caption_image }}</textarea>
                                        @error('caption_image')
