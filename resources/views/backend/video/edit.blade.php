                            ...
                            <div class="form-group">
                                <label for="video"><i class="fa fa-youtube" aria-hidden="true"></i> Content Video <span
                                    ...
                                    <div class="mt-2 input-group">
                                        ...
                                        <a class="btn btn-sm btn-primary input-group-text popup-youtube" href="{{$video->video}}">{{ __('View')}}</a>
                                    </div>
                                    <span class="font-italic"> Example: https://www.youtube.com/watch?v=LJ_YrtyEnc</span>
                                    @error('video')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    name="content">{{ old('content') ?? $video->content }}</textarea>
                                    @error('content')
                                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                                    @enderror
                                </div>
