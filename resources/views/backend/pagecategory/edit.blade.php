...
<section class="content">
    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.pagecategories.update', $pagecategory->id) }}" method="post">
        <div class="row">
            @csrf
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="mb-3 form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="title" value="{{ old('title') ?? $pagecategory->title }}" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Title" required>
                            </div>
                            @error('title')
                        ...
                        <div class="mt-3 text-center form-group">
                            <div class=" fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                    <img src="{{ $pagecategory->imageThumbUrl ? $pagecategory->imageThumbUrl : '/assets/images/no_image.png' }}" alt="...">
                                </div>
                        ...
                        <div class="box-footer text-end">
                            <a href="{{ route('backend.pagecategories.index') }}" class="btn btn-warning me-2">
                                Cancel
                            </a>
