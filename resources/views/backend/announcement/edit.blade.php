...
@section('content')
                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit a announcement</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.announcement.update', $announcement) }}"
            method="POST">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-lg-8 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Edit a Announcement
                            ...
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="title"
                                        ...
                                        value="{{ old('title') ?? $announcement->title }}" placeholder="Title" required>
                                </div>
                                @error('title')
                            ...
                            <div class="form-group">
                                <div class=" fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                        <img src="{{ $announcement->imageThumbUrl ? $announcement->imageThumbUrl : '/assets/images/no_image.png' }}"
                                            alt="...">
                                    </div>
