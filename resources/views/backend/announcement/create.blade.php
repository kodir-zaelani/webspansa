...
@section('content')
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page"><a
                                    href="{{ route('backend.announcement.index') }}">Announcement</a></li>
    ...
    <section class="content">
        <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.announcement.store') }}" method="post">
            <div class="row">
                @csrf
                <div class="col-lg-8 col-12">
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">Create a Announcement
                            </h4>
                        </div>
                        <div class="box-body">
                ...
                <div class="col-lg-4 col-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h4 class="box-title">
                                Fitur Image <span class="text-danger">*</span>
                            </h4>
                        </div>
