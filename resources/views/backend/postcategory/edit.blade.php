...
<section class="content">
    <form id="post-form" enctype="multipart/form-data" action="{{ route('backend.postscategories.update', $postcategory->id) }}" method="post">
        <div class="row">
            @csrf
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="mb-3 form-group">
                            ...
                            <div class="controls">
                                <input type="text" name="title" value="{{ old('title') ?? $postcategory->title }}" class="form-control @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="Title" required>
                            </div>
                            @error('title')
                                ...
                                <select class="form-control select2" style="width: 100%;" name="parent_id">
                                    ...
                                    @foreach ($datapostcategory as $item)
                                        <option value="{{ $item->id }}"
                                            ...
                                            @if ($item->id == $postcategory->parent_id) selected @endif>
                                            {{ $item->title }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="mt-3 text-center form-group">
                            <div class=" fileinput fileinput-new" data-provides="fileinput">
                                <div class="fileinput-new img-thumbnail" style="width: 200px;">
                                    <img src="{{ $postcategory->imageThumbUrl ? $postcategory->imageThumbUrl : '/assets/images/no_image.png' }}" alt="...">
                                </div>
