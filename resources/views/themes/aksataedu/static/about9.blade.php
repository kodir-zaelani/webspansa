            ...
            <div class="col-lg-3 col-md-6 col-12">
                <a href="#" class="pull-up">
                    <div class="p-10">
                        ...
                        <div class="mb-10 text-fade fs-16">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod..</div>
                    </div>
                </a>
            </div>
            <div class="col-lg-3 col-md-6 col-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-4 col-12">
                <div class="position-sticky t-80">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div>
                                            ...
                                            <h4 class="box-title text-primary mt-30"><i class="ti-list-o me-15"></i> Misi</h4>
                                            <hr class="my-15">
                                            <div class="row justify-content-center">
                                                <div class="col-md-11 col-12">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-10">1. Meningkatkan penguasaan Ilmu Pengetahuan dan Tehnologi (IPTEK)</li>
                                                        <li class="mb-10">2. Mengembangkan kecerdasan intelekual, emosional dan spiritual berdasarkan iman dan taqwa</li>
                                                        <li class="mb-10">3. Mendidik siswa agar memiliki wawasan kemasyarakatan, kebangsaan, dan global</li>
                                                        <li class="mb-10">4. Meningkatkan prestasi siswa dalam bidang akademik dan non akademik.</li>
                                                        <li class="mb-10">5. Mengembangkan budaya   mutu, pembelajar dan literasi.</li>
                                                        <li class="mb-10">6. Mengembangkan manajemen Berbasis Sekolah dan Manajemen Mutu Terpadu</li>
                                                        <li class="mb-10">7. Mendidik siswa agar memiliki wawasan dan perilaku   kepedulian dalam pelestarian lingkungan hidup</li>
                                                    </ul>

                                                </div>
                                            </div>
                                            <h4 class="box-title text-primary mt-30"><i class="ti-share me-15"></i> Tujuan</h4>
                                            <hr class="my-15">
                                            <div class="row justify-content-center">
                                                <div class="col-md-11 col-12">
                                                    <ul class="list-unstyled">
                                                        <li class="mb-10">1. Menguasai Ilmu Pengetahuan dan Tehnologi (IPTEK)</li>
                                                        <li class="mb-10">2. Memilki kecerdasan intelekual, emosional dan spiritual berdasarkan iman dan taqwa</li>
                                                        <li class="mb-10">3. Memiliki wawasan kemasyarakatan, kebangsaan, dan global</li>
                                                        <li class="mb-10">4. Berprestasi dalam bidang akademik dan non akademik.</li>
                                                        <li class="mb-10">5. Budaya literasi (gemar membaca literatur) berjalan dengan baik</li>
                                                        <li class="mb-10">6. Manajemen Berbasis Sekolah dan Manajemen Mutu Terpadu dilaksanakan secara konsisten</li>
                                                        <li class="mb-10">7. Memiliki wawasan dan perilaku  kepedulian dalam pelestarian lingkungan hidup</li>
                                                    </ul>
