...
<section class="bg-img pt-130 pb-50" data-overlay-light="5" style="background-image: url({{asset('')}}assets/images/front-end-img/banners/banner-2.jpg); background-position: top center;">
    <div class="container">
        <div class="row">
            <div class="col-12">
...
<section class="bg-white py-xl-100 py-50" data-aos="fade-up">
    <div class="container">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12 position-relative">
                            <div class="media-list media-list-hover media-list-divided md-post mt-lg-0 mt-30">
                                <a class="bg-white media media-single box-shadowed pull-up mb-15" href="#">
                                    <img class="rounded w-80 ms-0" src="{{ asset('') }}assets/images/front-end-img/avatar/1.jpg" alt="...">
                                    <div class="media-body fw-500">
                                        ...
                                        <p><small class="mt-10 text-fade">Johen doe</small></p>
                                    </div>
                                </a>
                                <a class="bg-white media media-single box-shadowed pull-up mb-15" href="#">
                                    <img class="rounded w-80 ms-0" src="{{ asset('') }}assets/images/front-end-img/avatar/2.jpg" alt="...">
                                    <div class="media-body fw-500">
                                        <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                        <small class="text-fade">Today, 5:00 PM</small>
                                        <p><small class="mt-10 text-fade">Johen doe</small></p>
                                ...
                                <a class="bg-white media media-single box-shadowed pull-up mb-15" href="#">
                                    <img class="rounded w-80 ms-0" src="{{ asset('') }}assets/images/front-end-img/avatar/3.jpg" alt="...">
                                    <div class="media-body fw-500">
                                        <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                        <small class="text-fade">Today, 5:00 PM</small>
                                        <p><small class="mt-10 text-fade">Johen doe</small></p>
                                ...
                                <a class="mb-0 bg-white media media-single box-shadowed pull-up" href="#">
                                    <img class="rounded w-80 ms-0" src="{{ asset('') }}assets/images/front-end-img/avatar/4.jpg" alt="...">
                                    <div class="media-body fw-500">
                                        <h5 class="overflow-hidden text-overflow-h nowrap">Basic English for IBPS SO/ IBPS PO/IBPS Clerk exams | 5 PM</h5>
                                        <small class="text-fade">Today, 5:00 PM</small>
                                        <p><small class="mt-10 text-fade">Johen doe</small></p>
...
<section class="py-50" data-aos="fade-up">
    <div class="container">
        <div class="row justify-content-center">
            <div class="text-center col-lg-7 col-12">
        ...
        <div class="row mt-30">
            <div class="col-12">
                <ul class="mb-10 nav nav-tabs justify-content-center bb-0" role="tablist">
        ...
        <div class="row mt-30">
            <div class="col-12">
                <div class="owl-carousel owl-theme owl-btn-1" data-nav-arrow="false" data-nav-dots="false" data-items="6" data-md-items="4" data-sm-items="3" data-xs-items="2" data-xx-items="2">
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-1.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-2.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-3.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-4.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-5.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-6.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-7.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-8.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-9.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-10.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-11.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                    <div class="item"><img src="{{ asset('') }}assets/images/front-end-img/unilogo/uni-12.jpg" class="rounded img-fluid my-15 box-shadowed pull-up" alt="" ></div>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <span class="mb-10 badge badge-success">Online</span>
                    ...
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <div class="d-flex flex-column fw-500">
                                    <a href="#" class="mb-1 text-dark hover-primary fs-16">Johen doe</a>
                    ...
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <div class="d-flex flex-column fw-500">
                                    <a href="#" class="mb-1 text-dark hover-primary fs-16">Anshu Srivastav</a>
                    ...
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <div class="d-flex flex-column fw-500">
                                    <a href="#" class="mb-1 text-dark hover-primary fs-16">Mical Doe</a>
                    ...
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <div class="d-flex flex-column fw-500">
                                    <a href="#" class="mb-1 text-dark hover-primary fs-16">Paton don</a>
                    ...
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <div class="d-flex flex-column fw-500">
                                    <a href="#" class="mb-1 text-dark hover-primary fs-16">Moriss Kothari</a>
                                    <span class="text-fade fs-12">Software Engineer</span>
                                </div>
                            </div>
                    ...
                    <div class="box-body">
                        <div>
                            <div class="d-flex align-items-center mb-30">
                                ...
                                <div class="d-flex flex-column fw-500">
                                    <a href="#" class="mb-1 text-dark hover-primary fs-16">Johens Kothari</a>
                                    <span class="text-fade fs-12">Software Engineer</span>
                                </div>
                            </div>
    ...
    <div class="container">
        ...
        <div class="row mt-30">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                <div class="card">
                    <a href="#">
                        <img class="card-img-top" src="{{ asset('') }}assets/images/front-end-img/courses/3.jpg" alt="Card image cap">
                    </a>
                    <div class="position-absolute r-10 t-10">
                        <button type="button" class="waves-effect waves-circle btn btn-circle btn-dark btn-xs me-5"><i class="fa fa-heart-o"></i></button>
                        <button type="button" class="waves-effect waves-circle btn btn-circle btn-dark btn-xs me-5"><i class="fa fa-share-alt"></i></button>
            ...
            <div class="text-center col-12">
                <a href="#" class="mx-auto btn btn-primary">View All Free Courses</a>
            </div>
        </div>
    </div>
</section>

<section class="py-50 bg-img countnm-bx" style="background-image: url({{asset('')}}assets/images/front-end-img/background/bg-3.jpg)" data-overlay="5" data-aos="fade-up">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                <div class="text-center">
                    <div class="mx-auto text-center border-white w-80 h-80 l-h-100 rounded-circle b-1">
                        <span class="text-white fs-40 icon-User"><span class="path1"></span><span class="path2"></span></span>
                    </div>
                    <h1 class="my-10 text-white countnm fw-300">5428</h1>
                    <div class="text-white text-uppercase">Teachers</div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-12">
                <div class="text-center">
                    ...
                    <h1 class="my-10 text-white countnm fw-300">120</h1>
                    <div class="text-white text-uppercase">Courses</div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-12">
                <div class="text-center">
                    ...
                    <h1 class="my-10 text-white countnm fw-300">7485</h1>
                    <div class="text-white text-uppercase">Student</div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 col-12">
                <div class="text-center">
                    ...
                    <h1 class="my-10 text-white countnm fw-300">100</h1>
                    <div class="text-white text-uppercase">Country</div>
                </div>
            </div>
        </div>
    </div>
...
<section class="py-50" data-aos="fade-up">
    <div class="container">
        ...
        <div class="row mt-30">
                ...
                <div class="blog-post">
                    <div class="clearfix entry-image">
                        <div class="owl-carousel bottom-dots-center owl-theme" data-nav-dots="true" data-autoplay="true"  data-items="1" data-md-items="1" data-sm-items="1" data-xs-items="1" data-xx-items="1">
                            <div class="item">
                                <img src="{{ asset('') }}assets/images/front-end-img/courses/2f.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('') }}assets/images/front-end-img/courses/3f.jpg" alt="">
                            </div>
                            <div class="item">
                                <img src="{{ asset('') }}assets/images/front-end-img/courses/4f.jpg" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="blog-detail">
            ...
            <d class="col-xl-4 col-md-4 col-12">
                <div class="blog-post">
                    <div class="clearfix entry-image">
                        <ul class="grid-post list-unstyled">
                            <li>
                                <img class="img-fluid" src="{{ asset('') }}assets/images/front-end-img/courses/5f.jpg" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('') }}assets/images/front-end-img/courses/6f.jpg" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('') }}assets/images/front-end-img/courses/7f.jpg" alt="">
                            </li>
                            <li>
                                <img class="img-fluid" src="{{ asset('') }}assets/images/front-end-img/courses/8f.jpg" alt="">
                            </li>
                        </ul>
                    </div>
                    <div class="blog-detail">
