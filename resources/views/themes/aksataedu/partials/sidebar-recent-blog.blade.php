<div class="box">
    <div class="box">
        <div class="box-header bg-primary">
            <h4 class="box-title"><strong>Blog Terbaru</strong></h4>
        </div>
        <div class="box-body">
            <div class="widget">
                @forelse ($global_recentblog as $item)
                <div class="clearfix recent-post">
                    ...
                    <div class="recent-post-info">
                        <a href="{{ route('blog.detail', $item->slug) }}" title="{{$item->title}}">{{Str::limit($item->title, 40)}}</a>
