...
$page_name = config('menu.page.name');
$page_url = config('menu.page.prefix');
                    ...
                    <div id="wpbody-content">
                        ...
                        <div class="wrap">
                            ...
                            <div class="manage-menus">
                                <form method="get" action="{{ $currentUrl }}">
                                    ...
                                    <div id="nav-menus-frame">
                                                            ...
                                                            <div class="accordion-section-content ">
                                                                <div class="inside">
                                                                    <div class="customlinkdiv" id="customlinkdiv">
                                                                        <div class="form-group">
                                                                            <label class="form-label">
                                                                                {{ __('URL') }} <span class="text-danger">*</span>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select class="form-control select2" style="width: 100%;" name="target" id="custom-menu-item-target" >
                                                                            <option value="_self" selected>Dalam Jendela</option>
                                                                            <option value="_blank" >Tab Baru</option>
                                                                        </select>
                                                                    </div>
                                                                    <div class="form-group ">
                                                                        <label class="form-label">{{ __('Type') }} </label>
                                                                        <select class="form-control select2" style="width: 100%;" name="type" id="custom-menu-item-type" >
                                        ...
                                        <h3 class="accordion-section-title hndle" tabindex="0">
                                            Pages <span class="screen-reader-text">Press return or
                                                enter
                                                to expand</span></h3>
                                                <div class="accordion-section-content ">
                                                    <div class="inside">
                                                        <div class="customlinkdiv" id="customlinkdiv">
                                                            <ul class="mb-3 menu-item-list">
                                                                ...
                                                                <li class="page-list">
                                                                    <input type="hidden" name="name-{{ $page->id }}" value="{{ $page->$page_name }}">
                                                                    <input type="hidden" name="slug-{{ $page->id }}" value="{{ $page_url . $page->slug }}">
                                                                    <input type="checkbox" class="checkbox"
                                                                    name="page[]" id="page-{{ $page->id }}" value="{{ $page->id }}">
                                                                    <label for="page-{{ $page->id }}">{{ $page->$page_name }}</label>
                                                                </li>
                                                                @endforeach
                                                                @endif
                                                            </ul>
                                                ...
                                                <p class="button-controls">
                                                    <p class="button-secondary">
                                                        ...
                                                        id="select-all-page">
                                                        <label for="select-all-page" onclick="selectallpage()">Select All</label>
                                                    </p>

                                                    <a href="#" onclick="addpagemenu()"
                                                    class="button-secondary submit-add-to-menu right">Add
                                                    menu item</a>
                                                    <span class="spinner" id="spincustomu"></span>
                                                </p>
                                ...
                                id="add-page">
                                <h3 class="accordion-section-title hndle" tabindex="0">
                                    Post Categories <span class="screen-reader-text">Press return or
                                        enter
                                        to expand</span></h3>
                                        <div class="accordion-section-content ">
                                            <div class="inside">
...
<div id="menu-management-liquid">
    <div id="menu-management">
            ...
            <li id="menu-item-{{ $m->id }}"
                ...
                <dl class="menu-item-bar">
                    <dt class="menu-item-handle">
                        <span class="item-title"> <span class="menu-item-title"> <span id="menutitletemp_{{ $m->id }}">
                            @if ($m->status == '0')
                    ...
                    </span> <span class="is-submenu" style="@if ($m->depth == 0) display: none; @endif">Subelement</span>
                </span>
                <span class="item-controls"> <span class="item-type">Edit</span>
        ...
        <div class="form-group ">
            <label class="form-label" for="edit-menu-item-type-{{ $m->id }}">{{ __('Type') }} </label>
            <select class="form-control select2 edit-menu-item-type" style="width: 100%;" name="type_menu_{{ $m->id }}" value="{{ $m->type }}" id="type_menu_{{ $m->id }}" >
                <option value="internal" @if ($m->type == 'internal')
                    @selected(true)
                    @endif>
                    Internal
                </option>
                <option value="eksternal" @if ($m->type == 'eksternal')
                    @selected(true)
                    @endif>
                    Eksternal
                </option>
