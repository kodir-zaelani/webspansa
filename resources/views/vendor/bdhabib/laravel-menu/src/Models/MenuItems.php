...
namespace Bdhabib\LaravelMenu\Models;
...
class MenuItems extends Model
{
    ...
    {
        return $this->belongsTo('Bdhabib\LaravelMenu\Models\Menus', 'menu');
    }

    public function child()
    {
        return $this->hasMany('Bdhabib\LaravelMenu\Models\MenuItems', 'parent')->orderBy('sort', 'ASC');
    }
}
