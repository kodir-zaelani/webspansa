                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a class="btn btn-xs btn-primary" href="{{ route('backend.announcement.create') }}"><i
                            ...
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                @if ($selectPage)
                                    <div class="mb-2 col-md-10">
                                        @if ($selectAll)
                                            <div>
                                                You have selected all <strong>{{ $dataannouncementall->total() }}</strong>
                                                items.
                                            </div>
                                        @else
                                            <div>
                                                ...
                                                want to Select All
                                                <strong>{{ $dataannouncementall->total() }}</strong>?
                                ...
                                @if ($dataannouncementall->count())
                                    <div class="table-responsive">
                                        <table class="table mb-0 table-hover">
                                            ...
                                            <tbody>
                                                @foreach ($dataannouncementall as $no => $item)
                                                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                                                        <th class="text-right" scope="row">
                                                            {{ $no + $dataannouncementall->firstItem() }}</th>
                                                        <td width="10%">
                                                        ...
                                                        <td class="text-center align-midle">
                                                            ...
                                                            <a title="Edit" class="btn btn-xs btn-warning edit-row"
                                                                href="{{ route('backend.announcement.edit', $item->id) }}">
                                    ...
                                    <div class="mt-3 row">
                                        <div class="col-xl-7 col-md-7 col-lg-7 col-12 ">
                                            {{ $dataannouncementall->links() }}
                                        </div>
                                        <div class="text-center col-xl-5 col-md-5 col-lg-5 col-12">
                                            Page : {{ $dataannouncementall->currentPage() }} | Show
                                            {{ $dataannouncementall->count() }} data of {{ $dataannouncementall->total() }}
                                        </div>
                                    </div>
                                @else
                                    <hr>
