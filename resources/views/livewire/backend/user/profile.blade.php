                        ...
                        <div class="tab-content">
                            ...
                            <div class="active tab-pane" id="settings">
                                ...
                                <div class="box no-shadow">
                                    ...
                                    <form class="form-horizontal" wire:submit="update" >
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input wire:model="displayname" type="text" class="form-control @error('displayname') is-invalid @enderror" placeholder="Displayname">
                                    ...
                                    <form class="form-horizontal" wire:submit="updatebio" >
                                        <div class="form-group">
                                ...
                                <div class="box no-shadow">
                                    <form class="form-horizontal" wire:submit="changeemail" >
                                        <div class="form-group">
                                            <label for="email">New Email <span class="text-danger">*</span></label>
                                            <input wire:model.live.debounce.150ms="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="New Email" />
                                    ...
                                    <form class="form-horizontal" wire:submit="changephone" >
                                        <div class="form-group">
                                            <label for="celuller_no">New Phone/Whatapps <span class="text-danger">*</span></label>
                                            <input wire:model.live.debounce.150ms="celuller_no" type="text" class="form-control @error('celuller_no') is-invalid @enderror" placeholder="New Phone/Whatapps" />
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input wire:model.live.debounce.150ms="current_password_for_phone" type="password" class="form-control @error('current_password_for_phone') is-invalid @enderror" placeholder="Current Password" />
                                            <span class="form-text text-muted">Your Password <code>in system</code></span>
                                    ...
                                    <form class="form-horizontal" wire:submit="changepassword" >
                                        <div class="form-group">
                                            ...
                                            <input wire:model.live.debounce.150ms="password" type="password" class="form-control @error('password') is-invalid @enderror" placeholder="New Password" />
                ...
                <div class="col-12 col-lg-5 col-xl-4">
                    <div class="box box-widget widget-user">
                        <div class="widget-user-header bg-img bbsr-0 bber-0" style="background: url('{{ asset('') }}assets/images/gallery/full/10.jpg') center center;" data-overlay="5">
                            <h3 class="text-white widget-user-username">{{ $name }}</h3>
                            <h6 class="text-white widget-user-desc">{{ $prevDisplayname }}</h6>
                        </div>
                        ...
                        <div class="box-footer">
                            <form class="form-horizontal" wire:submit="changeimage" >
                                <div class="mb-3">
