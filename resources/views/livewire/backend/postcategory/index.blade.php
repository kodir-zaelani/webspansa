                ...
                <div class="d-inline-block align-items-center">
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">Post Category</li>
                ...
                <div class="box box-bordered border-primary">
                    <div class="box-header with-border">
                        ...
                        <div class="box-controls pull-right">
                            <a  href="{{ route('backend.postscategories.create') }}" class="btn btn-primary btn-sm"> <i class="fa fa-plus" aria-hidden="true"></i> Add</a>
                        </div>
                    </div>
                    <div class="box-body">
                        <x-flash-message/>
                        ...
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-lg-12 col-12">
                                    ...
                                    <table class="table mb-0 table-hover">
                                        <tbody>
                                            <tr>
                                                ...
                                                @endforeach
                                                <th scope="col" width="20%">Post Count</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="@if ($this->isChecked($item->id))
                                                table-primary
                                                @endif">
                                                <th class="text-right" scope="row">{{ $no + $datapostcategory->firstItem() }}</th>
                                                <td width="10%">
                                                ...
                                                <td class="text-right align-midle">
                                                    <a title="Edit" class="btn btn-xs btn-warning edit-row" href="{{ route('backend.postscategories.edit', $item->id) }}">
                                                        <i class="fa fa-edit"></i>
                                                    </a>
                                                    @if ($item->masterstatus == config('cms.default_masterpagecategory') || $item->child->count() >= 1)
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 ">
                                        @if ($datapostcategory->total() > 10)
                                        <div class="col-12 ">
                                            {{ $datapostcategory->links() }}
                                        </div>
                                        @else
                                        <div class="col-12 text-start small text-muted">
                                            Page : {{ $datapostcategory->currentPage() }} | Show {{ $datapostcategory->count() }} data
                                            of {{ $datapostcategory->total() }}
                                        </div>
                                        @endif
                                    </div>
                                </div>
