<div>
    <div class="box box-outline-warning">
        <div class="box-header">
            <h4 class="box-title"><strong>{{__('Edit')}}</strong></h4>
        </div>
        <form enctype="multipart/form-data" >
            <div class="box-body">
                ...
                <div class="form-group">
                    <h5>Semester id</h5>
                    <div class="controls">
                        <input type="text" wire:model="semesterid" class="form-control @error('semesterid') is-invalid @enderror" placeholder="Semester id" readonly disabled>
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" wire:model="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="Nama" readonly disabled>
                        <small class="text-muted">Nama : 2003/2004 Ganjil/Genap</small>
                    </div>
                    @error('nama')
                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                    @enderror
