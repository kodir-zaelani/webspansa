            ...
            <div class="table-responsive">
                ...
                <tbody>
                    ...
                    <tr class="@if ($this->isChecked($item->id)) table-primary @endif">
                        ...
                        {{-- <td>
                            <div class="checkbox">
                                <input type="checkbox" id="Checkbox_{{ $no + $datablogall->firstItem() }}" value="{{ $item->id }}" wire:model="checked">
                                <label for="Checkbox_{{ $no + $datablogall->firstItem() }}"></label>
                            </div>
                        </td> --}}
                        <td width="10%">
                        ...
                        <td>
                            @if ($item->status == 1)
                            <a title="Show" href="{{route('blog.detail', $item->slug)}}" target="_blank" style="text-decoration: none;">
                            ...
                            <button wire:click="selectItem('{{ $item->id }}', 'primary')"
                                ...
                                <div class="mt-3 row">
                                    <div class="col-xl-12 col-md-12 col-lg-12 col-12 text-start small text-muted">
                                        @if ($datablogall->total() > 10)
                                        {{ $datablogall->links() }}
                                        @else
                                        Page : {{ $datablogall->currentPage() }} | Show {{ $datablogall->count() }} data
                                        of {{ $datablogall->total() }}
                                        @endif
                                    </div>
                                </div>
                                @else
