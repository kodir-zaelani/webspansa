        ...
        <form enctype="multipart/form-data" >
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="text" wire:model="nama" class="form-control @error('nama') is-invalid @enderror" placeholder="Name" required autofocus>
                ...
                <div class="form-group">
                    <h5>Tanggal Mulai </h5>
                    <div class="controls">
                        <input type="date" wire:model="tanggal_mulai" id="tanggal_mulai" class="form-control @error('tanggal_mulai') is-invalid @enderror" placeholder="Tanggal Mulai" >
                    </div>
                    @error('tanggal_mulai')
                    <div class="form-control-feedback"><small> <code>{{ $message }}</code> </small></div>
                    @enderror
                ...
                <div class="form-group">
                    ...
                    <div class="controls">
                        <input type="date" wire:model="tanggal_selesai" id="tanggal_selesai" class="form-control @error('tanggal_selesai') is-invalid @enderror" placeholder="Tanggal Selesai" >
                    </div>
            ...
            <div class="box-footer flexbox">
                <div class="flex-grow text-end">
                    <button class="btn btn-sm btn-primary" wire:click.prevent="update"><i class="fa fa-save" aria-hidden="true"></i> {{ __('Update') }}</button>
                    <button class="btn btn-sm btn-warning ms-10" wire:click='cancelEdit'><i class="ti-back-left pe-2"></i> {{ __('Cancel') }}</button>
                </div>
            </div>
        </form>
    </div>
