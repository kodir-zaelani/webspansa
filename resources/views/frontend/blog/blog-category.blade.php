        ...
        <div class="col-lg-8">
            <section id="category-section" class="category-section section">
                <div class="container section-title" data-aos="fade-up">
                    <h2>Semua Blog</h2>
                    <div><span>Kategori: </span> <span class="description-title">{{$blogs->first()->blogcategory->title}}</span></div>
                </div>
                            ...
                            <article class="list-post">
                                ...
                                <div class="post-content">
                                    <div class="category-meta">
                                        <a href="{{ route('post.category', $item->blogcategory->slug) }}" class="post-category">{{$item->blogcategory->title}}</a>
                                    </div>
                                    <h3 class="title">
                                        <a href="{{ route('news.detail', $item->slug) }}" title="{{$item->title}}">{{Str::limit($item->title, 40)}}</a>
                                    </h3>
                                    <div class="post-meta">
                                        <span class="read-time">{{ $item->reading_time }}</span>
