        ...
        <div class="col-lg-8">
            <section id="category-section" class="category-section section">
                <div class="container section-title" data-aos="fade-up">
                    <h2>Semua Berita</h2>
                    <div><span>Kategori: </span> <span class="description-title">{{$newspostcategory->first()->postcategory->title}}</span></div>
                </div>
                <div class="container" data-aos="fade-up" data-aos-delay="100">
                    <div class="row">
                        @foreach ($newspostcategory as $item)
