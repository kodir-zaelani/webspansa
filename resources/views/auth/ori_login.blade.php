        ...
        <div>
            ...
            <div class="mt-4">
                ...
                <div class="flex mt-4 justify-content-between">
                    <label for="remember_me" class="inline-flex items-center text-start">
                        <input id="remember_me" type="checkbox" class="text-indigo-600 border-gray-300 rounded shadow-sm focus:ring-indigo-500" name="remember">
                        <span class="text-sm text-gray-600 ms-2">{{ __('Remember me') }}</span>
                    </label>
                    @if (Route::has('password.request'))
                    <a class="ml-10 text-sm text-gray-600 underline rounded-md hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" href="{{ route('password.request') }}">
                ...
                <div class="flex items-center justify-end mt-4">
                    <a href="{{route('root')}}">{{ __('Beranda') }}</a>
